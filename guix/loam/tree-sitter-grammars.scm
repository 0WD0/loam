...
(define %loam-tree-sitter-grammars
  '((clojure
     ...
     (version . "0.0.14")
     (tag . #f)
     (commit . "10462c42c47699d695cc230c5abbe9bf1f279a01")
     (source-hash . "1f8n3zmgcg0ax30bg9knx2v5mqnypj2bhnswcr1j9n5pafjvaw5n")
     (repo . "https://github.com/0WD0/tree-sitter-clojure")
     (grammar-dir . ".")
     (query . "queries/highlights.scm")
     (license . "COPYING.txt")
     (license-output . "tree-sitter-clojure-CC0.txt")
     (aliases . ("clj" "cljs" "cljc" "edn"))
     (sample . "(require '[loam.defaults :as loam])\n\n(def system\n  (loam/create-system\n   {:extensions [my-extension]}))\n"))
